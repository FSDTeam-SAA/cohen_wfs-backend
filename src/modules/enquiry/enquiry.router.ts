...
router.post(
    '/us',
    RateLimiter.enquiryRateLimiter,
    validateRequest(EnquiryValidation.createEnquiryZodSchema),
...
router.get(
    '/export',
    Auth(USER_ROLE.ADMIN), // Protect business data
...
router.delete(
    '/:enquiryId',
    Auth(USER_ROLE.ADMIN),
    EnquiryController.delteEnquiry
);
